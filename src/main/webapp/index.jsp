...
<body id="page-top" class="index">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a class="page-scroll kr" href="#news">뉴스</a>
					</li>
					<li>
						<a class="page-scroll kr" href="#db">게임 DB</a>
					</li>
					<li>
						<a class="page-scroll kr" href="#schedule">게임 일정</a>
					</li>
					<li>
						<a class="page-scroll kr" href="#zone">게이머존</a>
					</li>
					<li>
						<a class="page-scroll kr" href="#market">중고장터</a>
					</li>
					<li>
						<a class="page-scroll kr">커뮤니티</a>
					</li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					...
					<div class="box box--responsive">
						This is a responsive box that will update it's ellipsis when the screen resizes. The quick brown fox jumped over the lazy dogs. The quick brown fox jumped over the lazy dogs. This is a responsive box that will update it's ellipsis when the screen resizes.
				...
				<div class="col-md-3 col-sm-6">
					...
					<div class="box box--responsive kr">
						넷마블게임즈(이하 넷마블, 대표 권영식)는 모바일 슈팅게임 '백발백중 for Kakao(이하 백발백중)'에서 전설 총기를 최초로 추가하고, 걸그룹 러블리즈 멤버 '유지애' 캐릭터를 출시한다고 4일 밝혔다.
						...
						넷마블게임즈 이정호 본부장은 “이번 업데이트는 ‘백발백중’ 총기의 기준을 상향하는 것으로, 총기 성장에 또 다른 재미를 선사하길 기대한다”며 “기존 이용자뿐만 아니라, 신규, 휴면 이용자에게 풍성한 혜택을 제공하는 이벤트를 진행하니 많은 참여를 부탁한다”고 말했다.

						모바일 슈팅게임 ‘백발백중’은 PC온라인 FPS 게임 수준의 타격감과 박진감을 높은 완성도로 구현했으며, 쉬운 조작 시스템으로 남녀노소가 부담 없이 슈팅게임을 즐길 수 있다. 게임에 대한 자세한 정보는 공식카페 및 공식 페이스북에서 확인할 수 있다.
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="news">
					...
					<div class="box box--responsive kr">
						스마일게이트 메가포트(대표 이동훈)의 인기 온라인 액션 레이싱 게임 '테일즈런너'(개발사 라온엔터테인먼트)가 ‘신규 캐릭터 공개’ 이벤트를 시작했다.

						이번 이벤트는 이용자들이 힘을 모아 올 여름 업데이트될 20번째 캐릭터에 대한 정보를 알아낼 수 있는 색다른 즐길 거리로, 이달 20일(수)까지 진행된다. 이벤트에 참여하고 싶은 이용자들은 '테일즈런너' 플레이 후 공식 홈페이지 내 이벤트 페이지에서 ‘응원하기’를 클릭하면 된다. ‘응원하기’는 이용자 당 하루에 한 번씩만 참여할 수 있다.

						스마일게이트 메가포트는 이용자들의 ‘응원하기’ 누적 횟수가 10만, 20만, 50만 등 목표치에 도달할 때 마다, 신규 캐릭터의 이름, 출신, 특징 등의 정보를 순차적으로 공개한다. 특히, 100만 회를 달성할 경우, 캐릭터의 원화도 제공할 예정이다.

						‘신규 캐릭터 공개’ 이벤트 및 게임 정보에 대한 세부 내용은 공식 홈페이지에서 확인할 수 있다.
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="news">
		...
		<div class="container">
			...
			<div class="row">
				<div style="text-align:center;">
					<img src="img/schedule.jpg" width="60%">
				</div>						
			</div>
		</div>
	</section>
	...
	<section id="zone" class="bg-light-gray">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 text-center">					
					<h3 class="section-subheading text-muted">자유게시판</h5>
				</div>
				<div class="col-md-4 col-sm-3 text-center">					
					<div>
						<img src="img/bbs/n13419263465.gif" style="width: 90%; max-width: 200px;">
					</div>
					<div class="text-elli kr">호우주의보 <span style="color:blue">[48]</span></div>
				</div>
				<div class="col-md-4 col-sm-3 text-center">
					<div>
						<img src="img/bbs/n10982595352.jpg" style="width: 90%; max-width: 200px;">
					</div>
					<div class="text-elli kr">공포의 방어막 만들기 <span style="color:blue">[35]</span></div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<ul class="list-inline">
						<li>
							<a style="text-decoration:none;">공지사항</a>
						</li>
						<li>
							<a style="text-decoration:none;">관리자 문의</a>
						</li>
