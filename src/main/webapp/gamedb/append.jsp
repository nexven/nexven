...
<script type="text/javascript">
	...
	app.controller("appendController", function($scope, $http) {
	    ...
	    $scope.format = function() {
			return JSON.stringify($scope.deptForm, null, 4)
		};
...
<form name="deptForm" novalidate="novalidate" data-ng-submit="submit()">
	...
	<input id="deptno" name="deptno" class="form-control" data-ng-model="dept.deptno" required="required" type="number" data-ng-min="0" data-ng-max="99" >
	</div>
