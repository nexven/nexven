...
<body data-ng-controller="AppendController" class="container">
	...
	<form name="empForm" method="post" novalidate="novalidate" data-ng-submit="submit()">
		
		<!-- empno -->
		<div class="form-group">
			<label for="empno">Empno</label>
			<input id="empno" type="number" name="empno" class="form-control" data-ng-model="emp.empno" data-ng-min="1000" data-ng-max="9999" required="required" />
...
<!-- 			<input id="deptno" name="deptno" type="number" class="form-control" data-ng-model="emp.deptno" data-ng-min="10" data-ng-max="99" /> -->
<!-- 			<div data-ng-show="empForm.deptno.$dirty"> -->
<!-- 				<div data-ng-show="empForm.deptno.$error.min">최소 10 이상으로 입력하세요.</div> -->
<!-- 				<div data-ng-show="empForm.deptno.$error.max">최대 99 이하로 입력하세요.</div> -->
<!-- 			</div> -->
			<label for="deptno">Deptno</label>
